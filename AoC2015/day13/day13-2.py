...
def method_name(input_content):
    ...
    seating_happiness['Me'] = {}
    for participant in find_participants(seating_happiness):
        seating_happiness['Me'][participant] = 0
    for key in seating_happiness.keys():
        seating_happiness[key]['Me'] = 0
...
def calculate_permutation_values(seating_happiness):
    participants = find_participants(seating_happiness)
...
def find_participants(seating_happiness):
